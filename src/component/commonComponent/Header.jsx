        ...
        <ToastContainer className={'z-[99999]'}/>
            ...
            <div className=' max-w-[100%]  z-[999] bg-[white] sticky px-4 top-0 '>
                <header className='max-w-[1330px] bg-[white] largelaptop:gap-0  flex m-auto largelaptop:px-0  laptop:items-center smallmob:flex-col laptop:flex-row tablet:justify-between mx-auto ' >
                    ...
                    <div className='laptop:flex hidden min-w-[400px] border-[#8B8BA3]  px-2 font-normal py-[8.2px] border largelaptop:rounded rounded-[7px]  items-center' >
                        <div className='text-[27px] text-[#8B8BA3] font-bold'><CiSearch className='font-black' /></div>
                        <div className='w-[80%]'>
                            <input type="text" placeholder='Try Saree,Kurti or Search by Product Code' className='outline-none rounded laptop:w-[100%] smallmob:w-[100%]  largelaptop:w-[100%] px-1' />
                        </div>
                    </div>
